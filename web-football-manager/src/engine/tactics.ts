...
const PRESETS: Record<TacticalStyle, Omit<TeamTactics, "style">> = {
  ...
  "control-possession": { mentality: 0.33, tempo: 0.52, directness: 0.24, pressing: 0.54, lineHeight: 0.6, width: 0.55, marking: "zonal", tackling: 0.45, shootOnSight: 0.52, creativeFreedom: 0.58, counterPress: 0.54, counterAttack: 0.32, focusPlay: 0, offsideTrap: 0.25 },
